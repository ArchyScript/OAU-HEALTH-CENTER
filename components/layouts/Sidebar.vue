<template>
  <aside class="hidden w-64 bg-gray-800 sm:block">
    ...
    >
      <NuxtLink to="/ro" class="text-white">Tailwind</NuxtLink>
    </div>
    ...
    <nav class="text-sm text-gray-300">
      <ul class="flex flex-col">
        ...
        <NuxtLink v-slot="{ isExactActive, href, navigate }" to="/" custom>
          <li
            class="px-4 cursor-pointer"
            :class="[
              isExactActive ? 'bg-gray-500 text-gray-800' : 'hover:bg-gray-700',
            ]"
          >
        ...
        <li
          class="px-4 py-2 mt-2 text-xs uppercase tracking-wider text-gray-500 font-bold"
        >
          Apps
        </li>
        ...
        <li class="px-4 cursor-pointer hover:bg-gray-700">
          <a href="#" class="py-2 flex items-center">
            ...
            Messages
            <span class="ml-auto text-xs bg-gray-500 px-2 py-1 rounded-sm"
              >16</span
            >
          </a>
        </li>
        ...
        <li class="px-4 cursor-pointer hover:bg-gray-700">
          <NuxtLink :to="{ name: 'login' }" class="py-2 flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 mr-2"
              fill="none"
